    ...
    return (
        <>
            <div
                ...
                className="group relative flex flex-col gap-4 rounded-xl bg-surface-dark p-4 shadow-xl transition-all border border-transparent hover:border-primary/40 cursor-pointer"
            >
