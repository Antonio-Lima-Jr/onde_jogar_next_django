...
export default function Footer() {
    return (
        <footer className="mt-20 border-t border-border-dark py-12 bg-surface-dark">
            <div className="max-w-[1280px] mx-auto px-10 flex flex-col md:flex-row justify-between items-center gap-8">
                <div className="flex items-center gap-3">
                    ...
                    <span className="text-base font-extrabold tracking-tight">SportDiscovery <span className="text-slate-500 font-medium text-sm ml-2">© 2024</span></span>
                </div>
