        ...
        <div className="flex min-h-screen items-center justify-center bg-[color:var(--color-background)] p-4 font-display">
            <div className="w-full max-w-md bg-[color:var(--color-surface)] p-10 rounded-[2rem] border border-[color:var(--color-border)] shadow-2xl relative overflow-hidden">
                ...
                <div className="text-center mb-10 relative">
                    ...
                    <h1 className="text-3xl font-extrabold text-[color:var(--color-text)] mb-2 tracking-tight">Welcome Back</h1>
                    <p className="text-[color:var(--color-muted)] font-medium">Login to start playing</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6 relative">
                    ...
                    <button
                        type="submit"
                        disabled={loading}
                        className="w-full bg-primary text-[color:var(--color-on-primary)] font-black py-5 rounded-full shadow-[0_0_30px_rgba(13,242,13,0.3)] hover:shadow-[0_0_40px_rgba(13,242,13,0.5)] transition-all disabled:opacity-50 transform active:scale-[0.98] mt-4"
                    >
